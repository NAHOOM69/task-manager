        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormData({ ...formData, status: value as 'active' | 'pending' | 'closed' })
              }
            >
              <SelectTrigger>
...
// המשך עם כל חלקי הקוד כפי שנכללו במקור, כולל state, filters, טיפול ברשימות, ואינטרפייסים של firebase.
